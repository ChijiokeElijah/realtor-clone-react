  ...
  return <>{landlord !== null && (
    <div className="flex flex-col w-full">
      ...
      <a href={`mailto:${landlord.email}?Subject=${listing.name}&body=${message}`}>
        <button className=" mb-6 py-3 px-7 bg-blue-600 text-white rounded text-sm uppercase shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out w-full text-center " type="button">Send Message</button>
      </a>
    </div>
  )}</>
