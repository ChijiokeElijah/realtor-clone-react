        ...
        <header className='flex justify-between items-center px-3 max-w-6xl mx-auto'>
            ...
            <div>
                <ul className='flex space-x-10'>
                    <li className={`py-3 text-sm font-semibold text-gray-400 cursor-pointer 
                    ...
                    <li className={`py-3 text-sm font-semibold text-gray-400 cursor-pointer 
                    border-b-[3px] border-b-transparent ${(pathMatchRoute("/sign-in") || pathMatchRoute("/profile")) && "!text-black !border-b-red-500"} `
