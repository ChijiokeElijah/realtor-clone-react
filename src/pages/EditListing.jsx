...
export default function CreateListing() {
  ...
  async function onSubmit(e){
    ...
    if(+DiscountedPrice >= +regularPrice){
      setLoading(false)
      toast.error('Discounted Price needs to be less than regular pricee')
      return;
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
        ...
        <div className="flex space-x-6 mb-6">
          <div>
            ...
            <input
              ...
              max="50"
              required
              className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 transition duration-150 ease-in-out
        ...
        {!geoLocationEnabled && (
          <div className="flex space-x-6 justify-start mb-6">
            <div>
              ...
              min="-90" max="90" onChange={onChange}  required  
      ...
      />
        ...
        text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out
        ">Edit Listing</button>
      </form>
    </main>
  );
