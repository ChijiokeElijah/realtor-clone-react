...
import {FaShare, FaBath, FaMapMarkerAlt, FaBed, FaParking, FaChair } from "react-icons/fa"
...
export default function Listing() {
    ...
    return <main>
        ...
        right-[3%] z-10 bg-white cursor-pointer border-2
         border-gray-400 rounded-full w-12 h-12 flex
        ...
        rounded-lg shadow-lg bg-white lg:space-x-5">
            <div className='w-full h-[200px] lg-[400px]'>
                <p className="text-2xl font-bold mb-3 text-blue-900">{listing.name} - $ {listing.offer ? listing.DiscountedPrice.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
